<div class="outside-of-work-wrapper">
				...
				<?php foreach($videos as $video) : ?>
					<div class="col-sm-6 col-md-3">
						<div class="video--listing">
							<a class="fancybox-media" href="https://www.youtube.com/watch?v=<?=$video['youtube_id'];?>">
								<div class="video__thumb">
									<?=$this->Image->resize('https://img.youtube.com/vi/' . $video['youtube_id']. '/0.jpg', array(
										'width' => 350,
										'height' => 290
									)); ?>
	...
	<div class="controls">
		<a id="up" href="#"><i class="fa fa-angle-up" aria-hidden="true"></i></a>
		<a id="down" href="#"><i class="fa fa-angle-down" aria-hidden="true"></i></a>
	</div>
