<div class="outside-of-work-wrapper">
	<div class="container-fluid">
		<div class="outside-of-work-header">
			...
			<div class="row text-xs-center" id="warning">
				<i>Warning: Unecessarily large images coming up, apologies in advance if you're paying per megabyte for your internet..</i>
			</div>
		</div>
	</div>
				...
				<div class="row scroll-to-display">
					<div class="col-md-6 offset-md-3 col-xs-12">
						<div class="text">
							...
							<p>It's a given really, who doesn't enjoy gaming. But I do get a bit competitive when it comes to particular games namely Rocket League, Call of Duty and Guitar Hero.</p>
						</div>
					</div>
				</div>
			</div>
