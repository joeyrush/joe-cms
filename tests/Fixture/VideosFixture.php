...
class VideosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'youtubeId' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'youtubeId' => 'Lorem ipsum dolor sit amet',
            'is_active' => 1,
            'created' => '2016-12-04 19:47:08',
            'modified' => '2016-12-04 19:47:08'
        ],
    ];
}
